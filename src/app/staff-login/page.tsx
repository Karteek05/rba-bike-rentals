...
function StaffLoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (mode === "login") {
      ...
      } as any); // Type cast to bypass strict typing for additional fields if needed
      ...
      >
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-brand-dark text-white shadow-[0_8px_16px_rgba(0,0,0,0.1)]">
            <Icon name={role === "admin" ? "shield" : "briefcase"} className="h-8 w-8" />
          </div>
          <h1 className="text-4xl font-black text-brand-dark">Staff Access</h1>
